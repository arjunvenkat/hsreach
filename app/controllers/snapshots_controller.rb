class SnapshotsController < ApplicationController
  ...
  def destroy
    @snapshot.destroy
    respond_to do |format|
      format.html { redirect_to :back, notice: 'Snapshot was successfully destroyed.' }
  ...
  private
    ...
    def snapshot_params
      params.require(:snapshot).permit(:user_id, :nwea_math, :nwea_reading, :math, :reading, :science, :social_studies)
    end
end
